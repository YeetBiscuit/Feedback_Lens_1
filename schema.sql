-- =====================================================
-- FEEDBACK GENERATION PIPELINE SCHEMA (MySQL)
-- Baseline version
-- =====================================================
...
CREATE TABLE tutors (
    ...
    institution_identifier VARCHAR(100) NOT NULL UNIQUE,
...
CREATE TABLE unit_tutors (
    unit_tutor_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE chunk_embedding_map (
    embedding_map_id INT AUTO_INCREMENT PRIMARY KEY,
    chunk_id INT NOT NULL,
    embedding_model VARCHAR(100) NOT NULL,
    embedding_version VARCHAR(50),
    vector_store_name VARCHAR(100) NOT NULL,
...
CREATE TABLE retrieval_records (
    retrieval_record_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE criterion_feedback (
    criterion_feedback_id INT AUTO_INCREMENT PRIMARY KEY,
    generation_id INT NOT NULL,
...
CREATE TABLE overall_feedback (
    overall_feedback_id INT AUTO_INCREMENT PRIMARY KEY,
    generation_id INT NOT NULL,
