...
-- =========================
-- 16A. EMBEDDED FEEDBACK EVALUATIONS
-- Optional, role-specific micro-evaluations for the research study
-- =========================
CREATE TABLE embedded_feedback_evaluations (
...
CREATE INDEX idx_embedded_feedback_evaluations_generation
    ON embedded_feedback_evaluations(generation_id);
CREATE INDEX idx_embedded_feedback_evaluations_role
    ON embedded_feedback_evaluations(participant_role);
CREATE INDEX idx_embedded_feedback_evaluations_rater
